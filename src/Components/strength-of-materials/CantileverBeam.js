...
const CantileverBeam = () => {
   ...
   const back=()=>{
    ...
    function submit(data){
      ...
      for(let i=0;i<8;i++){
        let x=(fdef[i]-0.23)
        E[i]=(load[i]*data.w3*data.w3*data.w3)/(3*I*x)
...
return (
  ...
  HOME
    ...
    <p className='flex justify-center md:text-4xl text-gray-500  pt-10'>BENDING TEST ON CANTILEVER BEAM</p>
    ...
    <div style={{display:'none'}}>
      <div ref={ComponentRef}>
        <Print10 arr1={arr1} arr2={arr2} arr3={arr3} initialdef='1.66' Ref="SM/W 183/2021-22"  res={res}   company="My Nest Developers," village="Narasimhapuram," city="Bhimavaram," dist="W.G.District."
         purpose='M30 grade RMC Concrete Cubes for "Construction of G+4 Costal Paradise apartment (B-Block) 1st slab, Narasimhapuram, Bhimavaram, W.G.District" -Reg.' dated='15-03-2023.' title='BENDING TEST ON CANTILEVER BEAMS:' lab='SM'/>

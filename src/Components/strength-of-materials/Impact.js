        ...
        {data.map(val => {
          return (
            <p>
              <u>
                {' '}
                <p className="md:text-xl md:mt-5 flex justify-center ">{val.head}</p>
              </u>
              <form onSubmit={val.handleSubmit(submit)}>
                <div style={{ textAlign: 'center' }}>
                  <Stack spacing={2} direction="column" className="w-auto   space-y-5  p-5 md:max-w-lg mx-auto">
                    <Textfield
                      label="Energy absorbed area specimen"
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-evenly' }}>
                      ...
                      <button onClick={val.handleprint} style={{ width: '20%' }} className=" bg-pink-600">
                        print
                      </button>
                    </div>
                    <div>
                    ...
                    <div style={{ fontSize: '20px' }}>
                      impact value: {val.result} j/cm<sup>2</sup>
                    </div>
                  </Stack>
                </div>
              </form>
              <div style={{ display: 'none' }}>
                <div ref={val.ComponentRef}>
                  <Print1
                    head="Energy absorbed area specimen"
                    head1="impact value: "
                    first={val.value}
                    res={val.result}
                  />

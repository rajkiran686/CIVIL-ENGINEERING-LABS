...
const Fineness = () => {  
 ...
 return (
    ...
    <div ref={ComponentRef}>
     <Print2 first={first} second={second} res={res} head1="Enter the weight of cement taken (W)" head2="Enter the weight retained on sieve (W1)" head3="percentage weight retained on sieve is:"/>
     </div>
     </div>
    </div>
  )

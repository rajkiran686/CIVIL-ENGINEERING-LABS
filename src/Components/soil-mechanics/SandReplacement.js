...
return (
    ...
    <Typography variant='h3' color='darkgrey' textAlign='center'>FIELD DENSITY-SAND REPLACEMENT METHOD</Typography>
...
export default SandReplacement
...
return (
    ...
    <Typography variant='h3' color='darkgrey' textAlign='center'>DISSOLVED OXYGEN</Typography>
    ...
    <Textfield label="Volume of Sample taken in ml" variant="outlined" name="v" register={register} valueAsNumber={true}  required={{value:true,message:"this field is required"}}   pattern={{value:/^(0|[1-9]\d*)(\.\d+)?$/,message:'enter the numbers only'}}  error={errors?.v} helperText={errors.v?.message}/><br/><br/>
    <Textfield label="Initial Burette reading" variant="outlined" name="w1" register={register} valueAsNumber={true}  required={{value:true,message:"this field is required"}}   pattern={{value:/^(0|[1-9]\d*)(\.\d+)?$/,message:'enter the numbers only'}}  error={errors?.w1} helperText={errors.w1?.message}/><br/><br/>
    <Textfield label="Final Burette reading" variant="outlined" name="w2" register={register} valueAsNumber={true}  required={{value:true,message:"this field is required"}}   pattern={{value:/^(0|[1-9]\d*)(\.\d+)?$/,message:'enter the numbers only'}}  error={errors?.w2} helperText={errors.w2?.message}/><br/><br/>
